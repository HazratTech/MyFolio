...
export const metadata: Metadata = {
    title: "Privacy Policy | RelayWorks",
    description: "Read our privacy policy to understand how RelayWorks collects, uses, protects, and handles your personal data.",
    alternates: {
        ...
        <main className="container mx-auto px-6 py-24 max-w-4xl">
            ...
            <div className="prose prose-invert max-w-none space-y-6 text-muted-foreground">
                ...
                <section>
                    ...
                    <p>
                        Welcome to the RelayWorks website. We respect your privacy and are committed to protecting your personal data.
                ...
                <section>
                    ...
                    <p>
                        If you have any questions about this privacy policy or our privacy practices, please contact us at <a href="mailto:contact@relayworks.dev" className="text-primary hover:underline">contact@relayworks.dev</a> or via the contact form on this website.
                    </p>
                </section>
            </div>
        </main>
